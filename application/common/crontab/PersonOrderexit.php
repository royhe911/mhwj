 ...
 * 订制订单取消后退款定时任务类
 * @author 贺强
 * @time   2018-12-04 20:23:25
 */
class PersonOrderexit extends Command
{
    /**
     * 设置定时任务时间执行规则
     * @author 贺强
     * @time   2018-12-04 20:23:30
     */
    protected function configure()
    {
        $this->setName('personexit')->setDescription('here is the remark');
    }

    /**
     * 执行定时任务
     * @author 贺强
     * @time   2018-12-04 20:23:53
     */
